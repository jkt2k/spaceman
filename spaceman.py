...
def test_is_guess_in_word(guess, secret_word):
    assert ord(guess) in list(range(65,91))+list(range(97,123)), "Guess is not a letter"
...
def test_is_word_guessed(secret_word, letters_guessed):
    for letter in letters_guessed:
        assert ord(letter) in list(range(65,91))+list(range(97,123)), "Guess contains character(s) other than letters"
    guessed=True
...
def test_spaceman(secret_word):
    assert len(secret_word)!=0, "Empty function input for spaceman"
